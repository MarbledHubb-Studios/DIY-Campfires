...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> FIREWOOD = registerBlock("firewood", () -> new FirewoodBlock(BlockBehaviour.Properties.copy(Blocks.OAK_WOOD).noOcclusion().ignitedByLava().strength(2.0F)));
